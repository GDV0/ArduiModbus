...
/*
  Modbus_RTU library
  Example of Mobus RTU Function code 01: Read Coils
...
void setup()
{
  ...
  // Modbus test type 
  Serial.println("");
  Serial.println("   Test Function code 07: Read Exception");
  Serial.println("   -------------------------------------");
}
...
{
  Serial.println("");
  Serial.println("  --> Read Exception register");
  Serial.println("      Result should be 0x55");
  // Build Client request
  Serial.println("");
  Serial.println("  Request sent by the Client");
  myClient.Client_ReadException(5, &myFrame);
...
/******************************************************************************
* t_status Modbus_CB_GetException(int* Value)
*     Callback function to read Exception register
* Parameters: 
*     - Value: pointer to a variable which will contain the Exception register value
* Return value: 
*     - OK if Exception register exists
*     - NOK if Exception register doesn't exist
******************************************************************************/
t_status Modbus_CB_GetException(int* Value)
{
  t_status Status = OK;
