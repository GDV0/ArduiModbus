...
//define registers
 int DeviceObj10= 0x1111;
 int DeviceObj11= 0x2222;
 int DeviceObj12= 0x3333;
 int DeviceObj13= 0x4444;
 int DeviceObj14= 0x5555;
...
void setup()
{
  ...
  // Modbus test type 
  Serial.println("");
  Serial.println("   Test Function code 06: Write Single Register");
  Serial.println("   --------------------------------------------");
}
...
void loop()
{
  ...
  // Then write 1 register
  Serial.println("");
  Serial.println("  --> Write 1 register at address 11");
  // Build Client request
  Serial.println("");
  Serial.println("  Request sent by the Client");
  myClient.Client_PresetSingleRegister(5, 11, 0x1234, &myFrame);
  DisplayFrame(&myFrame);
  ...
  // Finaly, read registers again 
  Serial.println("");
  Serial.println("  --> Read 5 registers from address 10");
  Serial.println("      Result should be 0x1111, 0x1234, 0x3333, 0x4444, 0x5555");
